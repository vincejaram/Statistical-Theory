...
#visualize data
ggplot(Alzheimers.Mice.Data, aes(x = Treatment, y = Training, group = AD_Status, color = factor(AD_Status))) +
  geom_line() +
  geom_point() +
  labs(title = "Training Errors by Treatment and AD Status", x = "Treatment", y = "Training Errors") +
  theme_minimal()
